...
Name : student.h
Author : Jay Rathod 
Description : This file provides API's for student to do tasks like view all courses, enroll new course, drop course, view enrolled courses, change password and logout.
============================================================================
*/
